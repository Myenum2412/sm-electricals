...
export interface ExpandableCardsHandle {
  scrollPrev: () => void;
  scrollNext: () => void;
}

const ExpandableCards = forwardRef<ExpandableCardsHandle, ExpandableCardsProps>(
  ({ cards, selectedCard: controlledSelected, onSelect, className = "", cardClassName = "" }, ref) => {
