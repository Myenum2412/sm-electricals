        ...
        <section className="py-12 md:py-16">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center">
                    <h2 className="text-4xl font-medium lg:text-5xl uppercase tracking-tight">SM ELECTRICAL <span className="lowercase font-normal text-muted-foreground">in numbers</span></h2>
